...
use Lefeto\ReservationBundle\Entity\Test;
...
class TestController extends Controller
{
    ...
    {
        $test = new Test();
        $form = $this->createForm('Lefeto\ReservationBundle\Form\TestType', $test);
    ...
    {
        $deleteForm = $this->createDeleteForm($test);
        $editForm = $this->createForm('Lefeto\ReservationBundle\Form\TestType', $test);
